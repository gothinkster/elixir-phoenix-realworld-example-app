defmodule RealWorld.Web.ProfileControllerTest do
  @moduledoc false
  use RealWorld.Web.ConnCase

  @user1_attrs %{email: "john@jacob.com", username: "john", password: "some password", bio: "some bio", image: "some image"}
  @user2_attrs %{email: "rick@jacob.com", username: "rick", password: "some other password", bio: "rick bio", image: "rick image"}
