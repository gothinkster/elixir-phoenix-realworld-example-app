defmodule RealWorldWeb.ArticleControllerTest do
  ...
  test "updates chosen article and renders article when data is valid", %{
    conn: conn,
    jwt: jwt,
    article: article
  } do
  ...
  test "returns the chosen article when is favorited by the user", %{
    conn: conn,
    jwt: jwt,
    article: article,
    user: user
  ...
  test "unfavorites an article favorited by the user", %{
    conn: conn,
    jwt: jwt,
    article: article,
    user: user
